        ...
        <div className="flex items-center">
          ...
          <button
           ...
           <button 
            ...
            className="flex items-center text-gray-600 dark:text-gray-300 hover:text-purple-500 dark:hover:text-purple-400 transition-colors p-2 rounded-full mr-2"
            aria-label="Go to Prompt & Skill Architect"
            title="Prompt & Skill Architect"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>
          </button>
          <button
            onClick={onDesignArchitectClick}
            className="flex items-center text-gray-600 dark:text-gray-300 hover:text-teal-500 dark:hover:text-teal-400 transition-colors p-2 rounded-full mr-2"
            aria-label="Go to Design Architect"
            title="Design Architect"
          >
            <span className="material-icons">design_services</span>
          </button>
          <button
            onClick={onArchitectureOrganizationClick}
            className="flex items-center text-gray-600 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400 transition-colors p-2 rounded-full mr-2"
            aria-label="Go to Architecture Organization"
