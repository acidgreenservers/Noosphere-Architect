  ...
  return (
    <div className="bg-transparent mt-12 animate-fade-in">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pb-6 mb-2 border-b border-slate-200/60 dark:border-slate-800/50 gap-4">
            <div>
                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200">Generated Project Blueprint</h3>
                <p className="text-xs text-slate-500 mt-1">Crystallized architectural blueprints based on your configuration.</p>
            </div>
