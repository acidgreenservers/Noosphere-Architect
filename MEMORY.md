...
- State masking is relative to local context.
- Deep object search needs recursive flat strings.
- Progressive disclosure reduces UI noise.
- Hover menus use clip-path for wipe effects.
- Active filters must be explicitly visible.
